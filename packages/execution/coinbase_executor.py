"""Coinbase order execution adapter using ccxt."""
...
class CoinbaseExecutor(ExecutionAdapter):
    """Coinbase order execution via ccxt."""
    ...
    async def submit_order(self, order: Order) -> Order:
        try:
            ...
            raise ExchangeError(f"Coinbase order submission failed: {e}") from e
    ...
    async def get_order_status(self, order_id: str, symbol: str) -> Order:
        try:
            ...
            raise ExchangeError(f"Coinbase order status failed: {e}") from e

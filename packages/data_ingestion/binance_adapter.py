"""Binance market data adapter using ccxt."""
...
class BinanceAdapter(MarketDataProvider):
    ...
    async def fetch_candles(
        ...
        """Fetch OHLCV candles from Binance with rate limiting."""
        ...
        try:
            ...
            raise ExchangeError(f"Binance fetch_candles failed: {e}") from e
    ...
    async def fetch_ticker(self, symbol: str) -> dict[str, float]:
        ...
        try:
            ...
            raise ExchangeError(f"Binance fetch_ticker failed: {e}") from e
        return {
    ...
    async def fetch_orderbook(
        ...
        try:
            ...
            raise ExchangeError(f"Binance fetch_orderbook failed: {e}") from e
